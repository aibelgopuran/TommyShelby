...
const need = "*type some word after command*\n*command kazhinj enthekilum ezhuth mwuthe😘"
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'aveng ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'Made by Tᴏᴍᴍʏ sʜᴇʟʙʏ' })
